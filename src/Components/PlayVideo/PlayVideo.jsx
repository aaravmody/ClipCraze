    ...
    return (
        <div className='play-video'>
            ...
            <div className="play-video-info">
                <p>{apiData?apiData.statistics.viewCount:"16k"} views &bull; {apiData?moment(apiData.snippet.publishedAt).fromNow():"2 days ago"}</p>
                <div>
            ...
            <div className="vid-description">
                <p>{apiData?apiData.snippet.description.slice(0,250):"Title"}</p>
                <hr />
                ...
                {commentData.map((item,index)=>{
                    ...
                    <div>
                        ...
                        <div className="comment-action">
                            <img src={item.snippet.topLevelComment.snippet.likeCount} />
                            <span> </span>
                            <img src={dislike} />
                            <span> </span>
                        </div>
